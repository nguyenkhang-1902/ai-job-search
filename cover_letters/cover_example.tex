...
% wrapped in Be Vietnam Pro so the bullet font matches the body (cover.cls
% pairs a refreshed Lato build with Be Vietnam Pro for full Vietnamese glyph
% coverage; the original bundled Raleway font drops most Vietnamese tone marks,
% and Be Vietnam Pro was chosen over an OS font like Times New Roman so the
% template stays portable and the Linux CI container can still compile it).
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
